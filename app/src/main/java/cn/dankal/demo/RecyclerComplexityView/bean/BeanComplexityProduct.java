...
//商品类
public class BeanComplexityProduct {
  //标题
  private String title;
  private List<BeanData> beanProductList;

  public BeanComplexityProduct(String title, List<BeanData> beanProductList) {
    this.title = title;
  ...
  public void setBeanProductList(
      List<BeanData> beanProductList) {
    this.beanProductList = beanProductList;
  }
