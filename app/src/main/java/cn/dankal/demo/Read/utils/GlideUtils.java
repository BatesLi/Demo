...
public class GlideUtils {
  ...
  public static void loadDetailImg(Context mContext,String url,ImageView imageView) {
  ...
  public static void loadMovieLatestImg(ImageView imageView, String url) {
    Glide.with(imageView.getContext())
        ...
        .placeholder(getDefaultPic(4))//设置占位图
        .error(getDefaultPic(4))
        .into(imageView);
  }
