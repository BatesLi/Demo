package cn.dankal.demo.Read.viewHelp;
...
import static cn.dankal.demo.Read.app.AppConstants.STATE_EMPTY;
import static cn.dankal.demo.Read.app.AppConstants.STATE_ERROR;
import static cn.dankal.demo.Read.app.AppConstants.STATE_LOADING;
import static cn.dankal.demo.Read.app.AppConstants.STATE_SUCCESS;
import static cn.dankal.demo.Read.app.AppConstants.STATE_UNKNOWN;
...
public abstract class LoadingPage extends FrameLayout {
  ...
  private View createErrorView() {
    errorView = LayoutInflater.from(mContext).inflate(R.layout.base_fragment_state_error, null);
  ...
  private View createEmptyView() {
    emptyView = LayoutInflater.from(mContext).inflate(R.layout.base_fragment_state_empty,null);
    return emptyView;
  }

  private View createLoadingView() {
    loadingView = LayoutInflater.from(mContext).inflate(R.layout.base_fragment_state_loading,null);
    imageView = (ImageView)loadingView.getRootView().findViewById(R.id.img_progress);
...
//关闭动画
  ...
  //根据网络获取的数据返回状态,每一个子类获取网络返回的都不一样，所以要交给子类去完成
